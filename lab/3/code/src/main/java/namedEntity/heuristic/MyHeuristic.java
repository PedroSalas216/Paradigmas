...
public class MyHeuristic extends Heuristic implements Serializable {
  ...
  public boolean isEntity(String word) {
    return names.contains(word) || surnames.contains(word) || countries.contains(word) || companies.contains(word);
  }
